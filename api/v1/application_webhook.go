...
//+kubebuilder:webhook:path=/mutate-apps-have2bfun-com-v1-application,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.have2bfun.com,resources=applications,verbs=create;update,versions=v1,name=mapplication.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-apps-have2bfun-com-v1-application,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.have2bfun.com,resources=applications,verbs=create;update,versions=v1,name=vapplication.kb.io,admissionReviewVersions={v1,v1beta1}
...
func (r *Application) validateApplication() error {
	if *r.Spec.Deployment.Replicas > 10 {
		return errors.New("too many replicas")
	}
	return nil
}
